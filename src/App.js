...
function App() {
  return (
    <div className="flex text-center md:text-start flex-col w-full max-w-full p-6 xl:px-20 xl:py-28">
      <div className="flex md:flex-row flex-col justify-center xl:justify-between">
        <div className="w-full flex flex-col gap-10 mb-14 max-w-sm lg:max-w-md">
          <h1 className="font-bold text-primary-color lg:text-6xl text-5xl">
